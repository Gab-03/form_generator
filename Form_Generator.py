...
class FileSelectorApp:
    ...
    def create_widgets(self):
        ...
        self.create_file_entry(1, "User Access Form (Word)", self.file2_path, self.browse_file2)
        self.create_file_entry(2, "Role Mapping Excel (Excel)", self.file3_path, self.browse_file3)
    ...
    def browse_file3(self):
        self.file3_path.set(filedialog.askopenfilename())

    def submit(self):
        file1 = self.file1_path.get()
        file2 = self.file2_path.get()
        file3 = self.file3_path.get()
        ...
        if file1 and file2 and file3:
            try:
                ...
                threading.Thread(target=self.read_files_and_process, args=(file1,file2, file3)).start()
    ...
    def read_files_and_process(self, file1,file2,file3):
